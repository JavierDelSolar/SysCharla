...
public class RetrofitUtil {
    ...
    private static Retrofit CharlaRetrofit;
...
//    }
    ...
    public static CharlaApi getCharlaApi(){
        if(charlaApi == null) {
            charlaApi = getRetrofitCharla().create(CharlaApi.class);
        }
        return charlaApi;
    }

    public static Retrofit getRetrofitCharla(){
        if(CharlaRetrofit == null){

            CharlaRetrofit = new Retrofit.Builder()
                    .baseUrl(BASE_URL_CHARLA)
                    .addConverterFactory(GsonConverterFactory.create())
                    .build();
        }
        return CharlaRetrofit;
    }
